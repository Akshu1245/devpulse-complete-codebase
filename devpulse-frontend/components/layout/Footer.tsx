    ...
    <footer className="footer">
      ...
      <div className="footer-top">
        ...
        <nav className="footer-nav">
          ...
          <a href="mailto:akshay@rakshex.in">Contact</a>
      ...
      <div className="footer-bottom">
        <span className="footer-copy">© 2026 RakshEx by Rashi Technologies. Bengaluru, India.</span>
        <Link href="/status" className="footer-status">
